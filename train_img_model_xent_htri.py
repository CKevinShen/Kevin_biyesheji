...
# Datasets
parser.add_argument('--root', type=str, default=r'reid\data', help="root path to data directory")
...
################################################################
parser.add_argument('--resume', type=str, default='checkpoint_1.pth', metavar='PATH')
...
def main():
    ...
    for epoch in range(start_epoch, args.max_epoch):
        ...
        if(epoch+1)%5 == 0:
            ...
            torch.save(save_checkpoint, 'checkpoint.pth')
