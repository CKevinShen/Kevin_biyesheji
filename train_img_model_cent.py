...
parser.add_argument('--resume', type=str, default='checkpoint_cent.pth', metavar='PATH')
...
def main():
    ...
    print("==> 从第{epoch}轮开始训练".format(epoch=start_epoch+1))
    ...
    for batch_idx, (imgs, pids, _) in enumerate(trainloader):
        ...
        if (batch_idx+1) % args.print_freq == 0:
            print('Epoch: [{0}][{1}/{2}]\t'
                ...
                data_time=data_time, loss=losses, losslr=optimizer_cent.param_groups[0]['lr'],
                optimizer=optimizer_model.param_groups[0]['weight_decay'],
