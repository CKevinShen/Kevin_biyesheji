...
# Datasets
parser.add_argument('--root', type=str, default='reid/data', help="root path to data directory")
...
def main():
    ...
    criterion = nn.CrossEntropyLabelLoss()
    ...
    best_rank1 = -np.inf
    best_epoch = 0
    print("==> Start training from the [{epoch}] epoch".format(epoch = start_epoch))
    ...
    for epoch in range(start_epoch, args.max_epoch):
        ...
        if(epoch+1)%5 == 0:
            ...
            torch.save(save_checkpoint, 'checkpoint_characterize learning.pth')
        ...
        if (epoch+1) > args.start_eval and args.eval_step > 0 and (epoch+1) % args.eval_step == 0 or (epoch+1) == args.max_epoch:
            ...
            save_checkpoint({
                ...
                'rank1': rank1,
                'epoch': epoch,
            }, is_best, osp.join(args.save_dir, 'checkpoint_ep_characterize learning' + str(epoch+1) + '.pth.tar'))
